...
var beaconLight = aircraft.light.new("/sim/model/lights/beacon", [0.08, 2], "/controls/lighting/beacon");
...
init_switches = func() {
    ...
    append(switch_list,"sim/model/lights/beacon/state");
    ...
    append(switch_list,"sim/model/lights/strobe/state");
...
if(getprop("/systems/electrical/outputs/landing-light[0]")>=15){
	setprop("/systems/electrical/outputs/landing-light-norm[0]", 1);
}else{
	setprop("/systems/electrical/outputs/landing-light-norm[0]", 0);
}
if(getprop("/systems/electrical/outputs/landing-light[1]")>=15){
